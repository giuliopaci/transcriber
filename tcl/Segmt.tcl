...
proc UpdateSegmtView {{mode initial}} {
    global v
    #
    # JOB: smartly show/hide segments (hide segments containing no annotation) 
    #
    # IN: wavfm, path of the segment
    # OUT: nothing
    # MODIFY: v(frame_view,*.seg1) v(frame_view,*.seg2) v(frame_view,*.bg)
    #
	...
	foreach lvl {seg1 seg2 bg} {
	    foreach s [array names v frame_view,*.$lvl] {
